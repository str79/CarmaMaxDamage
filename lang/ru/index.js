var langStr={
	...
	при клике с нажатым alt по надписи "группы" раскрывается/показывается меню групп.<br> \
	<br>------------Подробно--------<br> \
	...
	ctrl + клик по группе - позволяет переименовать группу<br> \
	alt + клик по группе - позволяет удалить группу<br> \
	...
	GpoupList - список групп - группы с довольно стандартным и определенным форматом, практически голый html<br> \
	',
};