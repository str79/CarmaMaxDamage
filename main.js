...
$(document).ready(function() {
	...
	$('#flyaoMenu .list-group-item .newprof').on('click',(event)=>{
		...
		//var defGroup="<div href=\"#\" class=\"list-group-item\"> \t\t<h4 class=\"list-group-item-heading\"><span class=\"icon\"></span><span class=\"text\">&nbsp;"+'test'+"</span></h4> \t\t</div> \t\t";
		var defGroup="['"+'\'test\''+"'] \t\t";
		//история
		//defGroup+="<div href=\"#\" class=\"list-group-item autohist\"> \t\t<h4 class=\"list-group-item-heading\"><span class=\"icon\"></span><span class=\"text\">&nbsp;"+'История'+"</span></h4> \t\t</div> \t\t";
